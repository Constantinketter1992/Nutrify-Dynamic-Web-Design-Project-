      ...
      <div class="row">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">
            <img class="img-responsive" src="img/cc_logo_small.png" alt="logo">
          </a>
        </div>
            ...
            <!-- else show sign up form and register button -->
              ...
              <!-- sign in form -->
  						<form class="navbar-form navbar-right" action="login.php" method="POST">
  						 ...
  						 <!-- register button -->
  						<li>
    						<button class="btn btn-success" id="reg2" onclick="window.location='register.php';">Register</button>
  						</li>
  				  <? } ?>
          </ul>
        </div>
